...
# Method 1:
es_method1 <- equal_share(disasters = disaster_numbers, fund1 = pa_funding, fund2 = hmgp_funding, input_df = fema)

# Method 2:
es_method2 <- equal_share(disasters = dist_nums, fund1 = funding_1, fund2 = funding_2, input_df = method2)
```


##Graphs

Graphing the results from the first method using the actual funding data  
