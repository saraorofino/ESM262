...
##Function
```{r load function}
source(here(),"assignments/assignment2/fish_revenue_edits.R", local = FALSE, echo = FALSE) #here() should get your local filepath all the way to "ESM262", and the rest gets you to the function script
fish_revenue
```
...
catch_data #this is the input data from for fish prices

fish_results <- fish_revenue(catch_data = catch_data, price_data = fish_prices)
